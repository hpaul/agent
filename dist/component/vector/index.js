...
import { getVectorIdInfo, getVectorTableName, vEmbeddingsWithoutDenormalizedFields, vVectorDimension, vVectorId, } from "./tables.js";
...
export const updateBatch = mutation({
    ...
    returns: v.null(),
    handler: async (ctx, args) => {
        await Promise.all(args.vectors.map((embedding) => {
...
export const deleteBatch = mutation({
    ...
    returns: v.null(),
    handler: async (ctx, args) => {
        await Promise.all(args.ids.map((id) => {
