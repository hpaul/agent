...
async function deletePageForUserId(ctx, args) {
    let threadInProgress = args.threadInProgress;
    let threadsCursor = args.threadsCursor;
    let messagesCursor = args.messagesCursor;
    let streamsInProgress = args.streamsInProgress ?? false;
    let streamOrder = args.streamOrder;
